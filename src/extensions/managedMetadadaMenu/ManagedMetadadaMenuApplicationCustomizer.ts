...
import * as strings from 'ManagedMetadadaMenuApplicationCustomizerStrings';

const LOG_SOURCE: string = 'ManagedMetadadaMenuApplicationCustomizer';
...
export default class ManagedMetadadaMenuApplicationCustomizer
  ...
  public async onInit(): Promise<void> {
    ...
    this._siteId = this.context.pageContext.site.id.toString();
    console.log("Site Id "+this._siteId);

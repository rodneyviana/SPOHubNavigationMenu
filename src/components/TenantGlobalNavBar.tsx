...
export default class TenantGlobalNavBar extends React.Component<ITenantGlobalNavBarProps, ITenantGlobalNavBarState> {
  ...
  public render(): React.ReactElement<ITenantGlobalNavBarProps> {
    ...
    const commandBarItems: IContextualMenuItem[] = this.props.menuItems.filter((i) => {
      console.log("site id: "+i.localCustomProperties["SiteId"]); return i.localCustomProperties["SiteId"] === this.props.siteId; }).map((i) => {
